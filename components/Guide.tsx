...
import { Guide as IGuide, GuideEpisode } from "contentlayer/generated";

interface GuideProps extends IGuide {
  featured?: boolean;
  firstEpisode: GuideEpisode;
}
...
function Guide({
  ...
  return (
    <article key={slug} className={wrapperClass}>
      <Link href={`/guides/${slug}/${firstEpisode.slug}`}>
